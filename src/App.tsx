...
import { fetchProducts, fetchCategories, Product } from './services/bigcommerce';
    ...
    const fetchData = async () => {
      try {
        ...
        const [productsData, categoriesData] = await Promise.all([
          fetchProducts(logError),
          fetchCategories(logError)
        ]);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">Discover our range of science-backed health solutions</p>
        </div>
